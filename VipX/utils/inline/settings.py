    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="⚡ αυ∂ισ qυαℓιтү⚡", callback_data="AQ"
            ),
            InlineKeyboardButton(
                text="⚡ vι∂εσ qυαℓιтү ⚡", callback_data="VQ"
            ),
        ],
        [
            InlineKeyboardButton(
                text="⚡ αυтн υsεяs ⚡", callback_data="AU"
            ),
            InlineKeyboardButton(
                text="⚡ cℓεαn мσ∂ε ⚡", callback_data="CM"
            ),
        ],
        [
            InlineKeyboardButton(
                text="💘 𝐆υℓυρ 💘", url=f"{SUPPORT_GROUP}",
            ),
            InlineKeyboardButton(
